...
export class EventsGateway implements OnGatewayConnection, OnGatewayDisconnect {
  ...
  async onJoinCourse(@MessageBody() data: JoinRoomDto, @ConnectedSocket() client: Socket) {
    await this.chatService.handleJoinCourse(data, client);
  }

  @SubscribeMessage('sendMessage')
  async onSendMessage(@MessageBody() data: SendMessageDto, @ConnectedSocket() client: Socket) {
  ...
  async onLeaveCourse(@MessageBody() data: JoinRoomDto, @ConnectedSocket() client: Socket) {
