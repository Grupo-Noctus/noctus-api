...
describe('CourseService', () => {
  ...
  describe('createCourse', () => {
    ...
    it('should throw BadRequestException if Prisma throws', async () => {
      ...
      await expect(service.createCourse({} as any, 1)).rejects.toThrow(BadRequestException);
    });
  });
  ...
  describe('updateCourse', () => {
    ...
    it('should throw BadRequestException on error', async () => {
      ...
      await expect(service.updateCourse(1, {} as any, 1)).rejects.toThrow(BadRequestException);
    });
  });
