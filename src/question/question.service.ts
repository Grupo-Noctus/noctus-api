...
async createQuestion(idModule: number,idExam: number,questionRequest: QuestionRequestDto,user: number,): Promise<boolean> {
  try {
  ...
  async updateQuestion(idModule: number,idExam: number,idQuestion: number, updateQuestion: UpdateQuestionDto, user:number): Promise<boolean> {
    try{
  ...
  async findOneQuestion(idModule: number,idExam: number,idQuestion: number): Promise <QuestionResponseDto> {
    try{
