...
-- AddForeignKey
ALTER TABLE `Exam` ADD CONSTRAINT `Exam_idModule_fkey` FOREIGN KEY (`idModule`) REFERENCES `Module`(`id`) ON DELETE RESTRICT ON UPDATE CASCADE;

-- AddForeignKey
ALTER TABLE `Question` ADD CONSTRAINT `Question_idExam_fkey` FOREIGN KEY (`idExam`) REFERENCES `Exam`(`id`) ON DELETE RESTRICT ON UPDATE CASCADE;
