...
CREATE TABLE `Student` (
    ...
    `needsSupportResources` BOOLEAN NULL DEFAULT false,
...
-- AddForeignKey
ALTER TABLE `Messages` ADD CONSTRAINT `Messages_idCourse_fkey` FOREIGN KEY (`idCourse`) REFERENCES `Course`(`id`) ON DELETE RESTRICT ON UPDATE CASCADE;

-- AddForeignKey
ALTER TABLE `Messages` ADD CONSTRAINT `Messages_idUser_fkey` FOREIGN KEY (`idUser`) REFERENCES `User`(`id`) ON DELETE RESTRICT ON UPDATE CASCADE;
